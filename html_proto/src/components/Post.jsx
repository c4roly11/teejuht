...
function Post() {
  ...
  const posts = [
    {
      ...
      content: "Siin on mõned praktilised nõuanded, mis aitavad sul stressiga paremini toime tulla: Lorem ipsum dolor sit amet, consectetur adipiscing elit..."
    },
    {
      category: "FINANTS",
  ...
  if (!post) {
    return <Container><h2>Postitust ei leitud</h2></Container>;
  }
